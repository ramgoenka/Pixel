# Pixel 
🐱 **Pixel** is a Discord bot written in Python and contains a bunch of random but useful commands. Functionality includes but is not limited to: greetings, sending cat images, asking trivia questions, playing games, performing basic and advanced mathematical computations, searching the web and returning search results, and much more, all of which make Pixel is a fun-to-use chatbot! Click below to invite the bot to your Discord server. 

[![Link For Invitation](https://img.shields.io/badge/Invite%20to%20Pixel%20Your%20Discord%20server-7289DA?style=for-the-badge&logo=discord&logoColor=white)](https://discord.com/api/oauth2/authorize?client_id=978663279926870046&permissions=248896&scope=bot)
